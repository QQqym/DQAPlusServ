...
public class LogNbiHwwgKpi {
    ...
    private Double hwwgvalue;

    private Double diffvalue;

    private String tablename;

    public LogNbiHwwgKpi(Integer intid, Integer taskid, String province, String city, String timestamp, String timezone, String period, String vendorname, String elementtype, String pmversion, String rmuid, String dn, String userlabel, String starttime, String objecttype, String pmname, Double bxvalue, Double hwwgvalue, Double diffvalue) {
        this.intid = intid;
        this.taskid = taskid;
        ...
        this.hwwgvalue = hwwgvalue;
        this.diffvalue = diffvalue;
    }

    public LogNbiHwwgKpi(String[] values,int taskid) {
        this.intid = null;
        ...
        this.hwwgvalue = StringUtils.isEmpty(values[16])?null:Double.parseDouble(values[16]);
        this.diffvalue = Double.parseDouble(values[17]);
        this.taskid = taskid;
    }

    public LogNbiHwwgKpi() {
        super();
    }
    ...
    public Double getHwwgvalue() {
        return hwwgvalue;
    }

    public void setHwwgvalue(Double hwwgvalue) {
        this.hwwgvalue = hwwgvalue;
    }
