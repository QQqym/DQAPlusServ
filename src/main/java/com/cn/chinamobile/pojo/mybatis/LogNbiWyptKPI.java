...
public class LogNbiWyptKPI {
    ...
    public LogNbiWyptKPI(Integer intid, String province, String city, String timestamp, String timezone, String period, String vendorname, String elementtype, String pmversion, String rmuid, String dn, String userlabel, String starttime, String objecttype, String pmname, Double bxvalue, Double wyptvalue, Double diffvalue) {
        this.intid = intid;
    ...
    public LogNbiWyptKPI(String[] values,int taskid) {
        this.intid = null;
